...
const SKIP_DATA_URL = "https://app.wewantwaste.co.uk/api/skips/by-location?postcode=NR32&area=Lowestoft";
// Add optional specialNotes to the static details type
const STATIC_DETAILS_BY_SIZE = {
    4: {
...
function mapSkipData(apiData) {
    return apiData.map(item => {
        ...
        const staticDetails = (_a = STATIC_DETAILS_BY_SIZE[size]) !== null && _a !== void 0 ? _a : {
            capacity: "N/A",
